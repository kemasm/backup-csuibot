...
# def test_meme_invalid_param(mocker):
#     error_regex = 'Invalid meme command format, (.+)'
#     mocked_reply_to = mocker.patch('csuibot.handlers.bot.reply_to')
#     mocker.patch('csuibot.handlers.meme', side_effect=ValueError)
#     mock_message = Mock(text='/meme <haha>')

#     meme(mock_message)

#     args, _ = mocked_reply_to.call_args
#     assert bool(re.match(error_regex, args[1]))
